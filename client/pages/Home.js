    ...
    return (
      <div className={'Home'}>
          ...
          <div className={'Home-plans-row'}>
            ...
            <div className={'Home-plans-plan'}>
              ...
              <ul>
                ...
                <li className={'Home-plans-plan-description'}>API tokens generation</li>
                <li className={'Home-plans-plan-description'}>Email support</li>
              </ul>
            </div>
          </div>
          <p className={'Home-plans-plan-footer'}>
            Is you project open source? Or maybe you just need an higher rate limit? <br />Read the
            FAQ below and feel free to <a href={'process.env.EMAIL_ADDRESS'}>contact me</a>
            .
          </p>
        </div>
        ...
        <div className={'Home-faq'}>
          ...
          <div className={'Home-faq-question'}>
            ...
            <p>
              ...
              a several rigorous rules for parsing, formatting, and validating phone numbers for all
          ...
          <div className={'Home-faq-question'}>
            ...
            <p>
              Validating a phone number allows you to keep your user database clean and fight fraud
          ...
          <div className={'Home-faq-question'}>
            ...
            <p>
              ...
              project: You can find all its code on Github, and if you think that the proposed price
              for the pro plan is too high you're free to install it in your own server.<br />
          ...
          <div className={'Home-faq-question'}>
            <h3>Why did you create NumValidate?</h3>
            <p>
          ...
          <div className={'Home-faq-question'}>
            ...
            <p>
              ...
              contributing on it on Github: Pull requests with new features/fixes and discussions
              are warmly welcomed.<br />You can also by subscribing to the pro plan.
            </p>
          </div>
        </div>
        ...
        <div className={'Home-footer'}>
          ...
          <a href={`mailto:${keys.EMAIL_ADDRESS || ''}?subject=NumValidate`}>Support</a>
        </div>
      </div>
    );
  }
